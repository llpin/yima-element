<template>
  <div>
    ...
    <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="w-50">
      ...
      <el-form-item label="账号类型" prop="loginInfo.accountType">
      ...
      <el-form-item label="手机" prop="loginInfo.enterpriseProfile.telephone">
        <el-input v-model="form.loginInfo.enterpriseProfile.telephone"></el-input>
      </el-form-item>
